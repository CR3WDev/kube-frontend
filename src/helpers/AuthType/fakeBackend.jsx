...
let users = [
  ...
  {
    uid: 2,
    username: "Marcelo Victor",
    role: "Marcelo Victor",
    password: "123",
    email: "marcelovtneves@gmail.com",
  },
];
...
const fakeBackend = () => {
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (validUser["length"] === 1) {
          ...
          reject([
            "Seu Email e senha estão incorretos. Por favor insira um email e senha válidos",
          ]);
        }
      });
    });
  ...
  mock.onPost("/fake-forget-pwd").reply((config) => {
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        resolve([200, "Olhe seu email e troque sua senha!."]);
      });
    });
  });
      ...
      setTimeout(() => {
        ...
        if (finalToken === accessToken) {
          if (validUser["length"] === 1) {
            ...
            resolve([200, "Perfil Atualizado com sucesso"]);
          } else {
            reject([
              400,
              "Alguma coisa deu errado ao tentar atualizar seu perfil, por favor, tente novamente!",
            ]);
          }
        } else {
